...
httpry -f source-ip,source-port,request-uri -d -i eth0 'tcp port 8080 or 8181 or 8151 or 8200 or 8201 or 8202 or 8203 or 8204 or 8205 or 8300 or 8301 or 8302 or 8303 or 8304 or 8305 or 8306 or 8307 or 8308 or 8386' -o /var/log/httpry.log 
...
# GUIs
su p3 -s /usr/bin/java -- -jar /usr/local/lib/p3-dashboard.jar  > /var/log/dashboard-gui.log 2>&1 &                                       # Port 8200
su p3 -s /usr/bin/java -- -jar /usr/local/lib/p3-pipeline-gui.jar > /var/log/pipeline-gui.log 2>&1 &                                      # Port 8201
su p3 -s /usr/bin/java -- -jar /usr/local/lib/p3-dictionary-matcher-factory-gui.jar > /var/log/dictionary-matcher-factory-gui.log 2>&1 &  # Port 8202
su p3 -s /usr/bin/java -- -jar /usr/local/lib/p3-batchrefine-factory-gui.jar -P 8203 > /var/log/batchrefine-factory-gui-gui.log 2>&1 &    # Port 8203
...
su p3 -s /usr/bin/java -- -jar /usr/local/lib/p3-geo-enriching-transformer.jar -P 8302  > /var/log/geo-enriching.log 2>&1  &              # Port 8302
su p3 -s /usr/bin/java -- -Xmx1g -jar /usr/local/lib/p3-any23-transformer.jar > /var/log/any23-transformer.log 2>&1 &                     # Port 8303
su p3 -s /usr/bin/java -- -Xmx4g -jar /usr/local/lib/p3-literal-extraction-transformer.jar > /var/log/literal-extraction.log 2>&1 &       # Port 8305
